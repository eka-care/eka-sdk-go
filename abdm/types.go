...
const (
	...
	SkipStateAbhaExists   SkipState = "abha_exists"
	SkipStateMobileVerify SkipState = "mobile_verify"
	SkipStateNone         SkipState = ""
	// Add more as needed based on API docs
)

// Headers represents common headers for API requests
type Headers struct {
	UserID string
	HipID  string
}
...
type VerifyResponse struct {
	TxnID        string           `json:"txn_id"`
	SkipState    SkipState        `json:"skip_state"`
